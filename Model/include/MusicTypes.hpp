...
typedef std::unordered_map<boost::uuids::uuid, Arcusical::Model::Album, boost::hash<boost::uuids::uuid>>
    AlbumCollection;
...
typedef std::unordered_map<boost::uuids::uuid, const Arcusical::Model::Song*, boost::hash<boost::uuids::uuid>>
    SongPtrCollection;
