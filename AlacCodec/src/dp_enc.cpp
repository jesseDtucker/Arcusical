...
void pc_block(int32_t* in, int32_t* pc1, int32_t num, int16_t* coefs, int32_t numactive, uint32_t chanbits,
              uint32_t denshift) {
  ...
  if (numactive == 0) {
    ...
    if ((num > 1) && (in != pc1)) memcpy(&pc1[1], &in[1], (num - 1) * sizeof(int32_t));
    return;
  }
  if (numactive == 31) {
