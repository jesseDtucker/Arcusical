...
#define BSWAP64(x)                                                                                                   \
  ((((int64_t)x << 56) | (((int64_t)x << 40) & 0x00ff000000000000LL) | (((int64_t)x << 24) & 0x0000ff0000000000LL) | \
    (((int64_t)x << 8) & 0x000000ff00000000LL) | (((int64_t)x >> 8) & 0x00000000ff000000LL) |                        \
    (((int64_t)x >> 24) & 0x0000000000ff0000LL) | (((int64_t)x >> 40) & 0x000000000000ff00LL) |                      \
