...
namespace Arcusical {
  namespace ViewModel {
    ...
    public ref class WhatIsPlayingVM sealed : INotifyPropertyChanged_t {
    public:
    ...
    internal:
      WhatIsPlayingVM(Player::Playlist& playlist, Player::IPlayer& player, Util::BackgroundWorker& worker, MusicProvider::MusicProvider& musicProvider);
