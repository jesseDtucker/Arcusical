...
namespace Arcusical { namespace MPEG4 {
	...
	const std::vector<unsigned char> iCover::PNG_HEADER_START = boost::assign::list_of(0x89)(0x50)(0x4E)(0x47)(0x0D)(0x0A)(0x1A)(0x0A);
	...
	std::vector<unsigned char>::const_iterator iCover::GetImageData()
	{
		return m_imageData;
	}

	uint64_t iCover::GetImageDataSize()
	{
		return m_imageDataSize;
	}

	ImageType iCover::GetType()
	{
		return m_type;
	}
