...
Mdhd::Mdhd() : m_creationTime(0), m_modificationTime(0), m_timeScale(0), m_duration(0), m_version(0) {}
...
uint64_t Mdhd::GetCreationTime() { return m_creationTime; }

uint64_t Mdhd::GetModificationTime() { return m_modificationTime; }

uint32_t Mdhd::GetTimeScale() { return m_timeScale; }

uint64_t Mdhd::GetDuration() { return m_duration; }

std::vector<uint8_t> Mdhd::GetLanguage() { return m_language; }
