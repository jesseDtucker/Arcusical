...
namespace Arcusical { namespace MPEG4 {
	...
	Mvhd::Mvhd() :	m_version(0), m_creationTime(0), m_modificationTime(0),
					m_timeScale(0), m_duration(0), m_rate(0), m_volume(0),
					m_nextTrackId(0)
	{
	...
	float Mvhd::GetVolume()
	{
		return m_volume;
	}

	std::vector<uint32_t> Mvhd::GetMatrix()
	{
		return m_matrix;
	}

	uint32_t Mvhd::GetNextTrackId()
	{
