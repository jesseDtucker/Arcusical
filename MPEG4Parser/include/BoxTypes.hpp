...
namespace Arcusical { namespace MPEG4 {
	...
	const std::unordered_map<std::string, BoxType> StringToBoxType = boost::assign::map_list_of<std::string, BoxType>
		...
		("©nam", BoxType::iNAME)
		("©ART", BoxType::iArtist)
		("aART", BoxType::iAlbumArtist)
		("©alb", BoxType::iAlbum)
		("gnre", BoxType::iGenre)
		("trkn", BoxType::iTrackNumber)
		("disk", BoxType::iDiskNumber)
		("cpil", BoxType::iCpil)
		("pgap", BoxType::iPgap)
		("©day", BoxType::iReleaseDate)
		("apID", BoxType::iAppleID)
		("cprt", BoxType::CPRT)
		("cnID", BoxType::iCNID)
		("rtng", BoxType::iRtng)
		("atID", BoxType::iATID)
		...
		("stik", BoxType::iSTIK)
		("tmpo", BoxType::iTMPO)
		("purd", BoxType::iPurchaseDate)
		("xid ", BoxType::iXID)
		("flvr", BoxType::iFLVR)
		("covr", BoxType::iCOVR)
		("©too", BoxType::iEncoderName)
		("©wrt", BoxType::iComposer)
		("mdat", BoxType::MDAT)
		("alac", BoxType::ALAC)
		("Xtra", BoxType::XTRA);
	...
	const std::unordered_map<BoxType, std::string> BoxTypeToString = boost::assign::map_list_of<BoxType, std::string>
		...
		(BoxType::iArtist, "©ART")
		(BoxType::iAlbum, "aART")
		(BoxType::iAlbumArtist, "©alb")
		(BoxType::iGenre, "gnre")
		(BoxType::iTrackNumber, "trkn")
		(BoxType::iDiskNumber, "disk")
		(BoxType::iCpil, "cpil")
		(BoxType::iPgap, "pgap")
		(BoxType::iReleaseDate, "©day")
		(BoxType::iAppleID, "apID")
		(BoxType::CPRT, "cprt")
		(BoxType::iCNID, "cnID")
		(BoxType::iRtng, "rtng")
		(BoxType::iATID, "atID")
		...
		(BoxType::iSTIK, "stik")
		(BoxType::iTMPO, "tmpo")
		(BoxType::iPurchaseDate, "purd")
		(BoxType::iXID, "xid ")
		(BoxType::iFLVR, "flvr")
		(BoxType::iCOVR, "covr")
		(BoxType::iEncoderName, "©too")
		(BoxType::iComposer, "©wrt")
		(BoxType::MDAT, "mdat")
		(BoxType::ALAC, "alac")
		(BoxType::XTRA, "Xtra");
