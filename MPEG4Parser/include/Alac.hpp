...
const std::unordered_map<uint32_t, AlacChannelLayout> NumToAlacChannelLayout =
    boost::assign::map_list_of<uint32_t, AlacChannelLayout>(
        (100 << 16) | 1, AlacChannelLayout::ALACChannelLayoutTag_Mono)((101 << 16) | 2,
                                                                       AlacChannelLayout::ALACChannelLayoutTag_Stereo)(
...
const std::unordered_map<AlacChannelLayout, std::string> AlacChannelLayoutToString =
    boost::assign::map_list_of<AlacChannelLayout, std::string>(AlacChannelLayout::ALACChannelLayoutTag_Mono, "Mono")(
        AlacChannelLayout::ALACChannelLayoutTag_Stereo, "Stereo")(AlacChannelLayout::ALACChannelLayoutTag_MPEG_3_0_B,
                                                                  "Center Left Right")(
        ...
        AlacChannelLayout::ALACChannelLayoutTag_MPEG_7_1_B, "C Lc Rc L R Ls Rs LFE")(AlacChannelLayout::UNKNOWN,
                                                                                     "Unknown");
