...
namespace Arcusical { namespace MPEG4 {
	...
	const std::unordered_map<uint8_t, ES_Tag> CharToESTag = boost::assign::map_list_of<uint8_t, ES_Tag>
		(0x03, ES_Tag::ES_DESC)
		(0x04, ES_Tag::DECODER_CONFIG)
		(0x05, ES_Tag::DECODER_INFO)
		(0x06, ES_Tag::SL_CONFIG_DESC);
	...
	struct DecoderConfigDescription
	{
		...
		DecoderConfigDescription() : m_objectTypeID(0), m_streamType(0),
				m_bufferSize(0), m_maxBitRate(0), m_averageBitRate(0)
		{}
	};
